...
function Particle(x, y) {
  ...
  // this.r = Math.random() * 2 * Math.PI;
	this.r = Math.random() * 2 * Math.PI / 2.5;
...
function initScene() {
  ...
  // ctx.font = 'bold 30vw "Abril Fatface"';
	ctx.font = 'bold 30vw "Arial"';
  ...
  particles = [];
  for (var i = 0; i < ww; i += Math.round(ww / 120)) {
    for (var j = 0; j < wh; j += Math.round(ww / 120)) {
